...
public protocol LightboxControllerShareDelegate: AnyObject {
    
    func lightboxControllerWillShare(_ controller: LightboxController, _ index: Int)
}
...
open class LightboxController: UIViewController {
    ...
    open weak var shareDelegate: LightboxControllerShareDelegate?
